...
namespace mth // Space math namespace
{
  ...
  public:
    ...
    */
     ...
     *   (matr) result matr.
     */
    matr<Type> operator*( matr<Type> A ) const
    {
      matr<Type> r = {};
    ...
    ***/
     ...
     *   (matr) rotate matrix.
     */
    static matr<Type> RotateX( Type Deg )
    {
      DBL Angl = D2R(Deg);
      DBL si = sin(Angl), co = cos(Angl);
      return matr(1, 0, 0, 0,
     ...
     *   (matr) rotate matrix.
     */
    static matr<Type> RotateY( Type Deg )
    {
      DBL Angl = D2R(Deg);
      DBL si = sin(Angl), co = cos(Angl);
      return matr(
     ...
     *   (matr) rotate matrix.
     */
    static matr<Type> RotateZ( Type Deg )
    {
      DBL Angl = D2R(Deg);
      DBL si = sin(Angl), co = cos(Angl);
      return matr(
    ...
    */
     ...
     *   (matr) scale matrix.
    */
    static matr<Type> Translate( const vec3<Type> &A )
    {
      return matr(
          1, 0, 0, 0,
          0, 1, 0, 0,
    ...
    ***/
    ...
    {
      return
        vec3(V.X * M[0][0] + V.Y * M[1][0] + V.Z * M[2][0] + M[3][0],
